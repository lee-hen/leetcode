...
func GetListOfWords() []string {
	...
	wordList := []string{"the", "of", "and", "a", "to", "in", "is", "be",
		...
		"within", "done","along", "turned", "god", "sense", "week", "best",
		"change", "kind", "began", "child", "ever", "law", "matter", "least",
		...
		"charge", "farm", "fear", "others", "determine", "hair",
		...
		"officials", "operator", "Senate", "lend", "hearts",
